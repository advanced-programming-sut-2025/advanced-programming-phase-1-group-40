...
//    DRIED_FRUIT("Dried Fruit", "Chewy pieces of dried fruit.", 75, 24, createIngredientsMap(ProductType.ANY_FRUIT_EXCEPT_GRAPES, 5), 7.5 * FruitBasePrice + 25),WOOL  DUCK_EGG  DINOSAUR_EGG  TRUFFLE
...
//    COAL("Coal", "Turns 10 pieces of wood into one piece of coal.", "Inedible", 1, createIngredientsMap(ProductType.WOOD, 10), 50),
    CLOTH("Cloth", "A bolt of fine wool cloth.", 0, 4, createIngredientsMap(new AnimalProduct(models.enums.types.AnimalProductType.COW_MILK), 1), 470),
...
//    LARGE_MAYONNAISE("Large Mayonnaise", "It looks spreadable.", 50, 3, createIngredientsMap(ProductType.LARGE_EGG, 1), 237),
    DUCK_MAYONNAISE("Duck Mayonnaise", "It's a rich, yellow mayonnaise.", 75, 3, createIngredientsMap(new AnimalProduct(models.enums.types.AnimalProductType.DUCK_EGG), 1), 375),
    DINOSAUR_MAYONNAISE("Dinosaur Mayonnaise", "It's thick and creamy, with a vivid green hue. It smells like grass and leather.", 125, 3, createIngredientsMap(new AnimalProduct(models.enums.types.AnimalProductType.DINOSAUR_EGG), 1), 800),
    TRUFFLE_OIL("Truffle Oil", "A gourmet cooking ingredient.", 38, 6, createIngredientsMap(new AnimalProduct(models.enums.types.AnimalProductType.TRUFFLE), 1), 1065),
